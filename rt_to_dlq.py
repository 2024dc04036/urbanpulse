...
consumer = KafkaConsumer(
    ...
    value_serializer=None, # Process raw bytes for safe verification
)
...
def evaluate_and_route():
    print("🛡️ UrbanPulse Inline Validation Shield Active...")
...
def route_to_dlq(original_topic, payload, error_type):
    ...
    print(f"📌 [DLQ ROUTE] Enqueued corrupt message into DLQ. Error type: {error_type}")
